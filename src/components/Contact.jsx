...
const Contact = () => {
  return (
    ...
    >
      <form
        method="POST"
        action="https://getform.io/f/c7212d7a-ef43-4018-9d30-9fd93d314283"
      ...
      >
        ...
        <textarea
          ...
          placeholder="Message"
        ></textarea>
        <button className="text-white text-3xl border-2 hover:bg-green-400 hover:border-green-400 px-4 py-3 my-8 mx-auto flex items-center">
          Let's Collaborate!
        </button>
      </form>
    </div>
